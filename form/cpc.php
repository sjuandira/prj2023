...
<head>
  ...
  <meta
    content="Daftar Competitive Programming Competition PRJ x HT XI Ignite : Unleashing the Spark of Youth Potential"
    name="description" />
  <meta content="PRJxHT, PRJxHT 11, Daftar, CPC, Competitive Programming Competition" name="keywords" />
...
<body>
  <div class="row bg-cpc m-0">
    ...
    <div class="col-12 col-md-6 mx-auto">
      <form action="action/cpcAct" method="post" enctype="multipart/form-data" class="formm">
        <h1 style="color: white;">Daftar Competitive Programming Competition</h1>
